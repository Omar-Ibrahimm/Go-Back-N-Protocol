...
char MyMessage_Base::getParity() const
{
    return this->parity;
}

void MyMessage_Base::setParity(char parity)
{
    this->parity = parity;
}
...
int MyMessage_Base::getAckNumber() const
{
    return this->ackNumber;
}

void MyMessage_Base::setAckNumber(int ackNumber)
{
